...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/layout-components-plugin
  TARGETDIR  = ../../../output/lib/wxformbuilder
  TARGET     = $(TARGETDIR)/liblayout-30.so
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/layout-components-plugin
  TARGETDIR  = ../../../output/lib/wxformbuilder
  TARGET     = $(TARGETDIR)/liblayout.so
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking layout-components-plugin
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning layout-components-plugin
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/layout.o: ../../../plugins/layout/layout.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
