...
Escena= display(title='Impresion 2d',x=0, y=0, width=600, height=500,center=(5,0,0), background=(0.2,0.3,1))
...
piso  = box(pos=(0,-3,0), lenght=0,width=60, height=80, axis=(0,1,0),color=color.orange) #axis(0,altura,0) grosor tabla
